 ...
 */
@RestController
@RequestMapping("/education/users")
public class UsersController extends BaseController
{
     ...
     * 查询用户列表
     */
    @PreAuthorize("@ss.hasPermi('education:users:list')")
    @GetMapping("/list")
     ...
     * 导出用户列表
     */
    @PreAuthorize("@ss.hasPermi('education:users:export')")
     ...
     * 获取用户详细信息
     */
    @PreAuthorize("@ss.hasPermi('education:users:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增用户
     */
    @PreAuthorize("@ss.hasPermi('education:users:add')")
     ...
     * 修改用户
     */
    @PreAuthorize("@ss.hasPermi('education:users:edit')")
     ...
     * 删除用户
     */
    @PreAuthorize("@ss.hasPermi('education:users:remove')")
